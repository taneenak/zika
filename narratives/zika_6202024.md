...
Look at the three clustering together and they share a common ancestor. This suggests a single introduction transmission that was followed by local transmission.
The virus stays there for quite some time before it mutates into different branches. 

# [Sig and Thai](https://nextstrain.org/community/taneenak/zika?d=tree,map&f_country=Singapore,Thailand&p=full)
They are the outliers. 
All cases in Facility B cluster into a single clade, and here the internal node suggests a common ancestor.


# [Brazil](https://nextstrain.org/community/taneenak/zika?d=tree,map&f_country=Brazil,Colombia,Panama,Venezuela&p=full)
These four countries cluster together. Brazil is the common ancestor. 
But some of Brazil's stops.
