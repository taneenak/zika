...
# [Hands-On Practice](https://nextstrain.org/community/taneenak/zika)

This part of the workshop focused on hands-on practice, allowing participants to create their own slides for the narrative while we addressed any challenges they encountered.

Participants were also encouraged to consider their own datasets, choose the parts they needed most, and apply the same logic to Zika dataset. 

I will not go into too many details for the next slides, as I will concentrate on demonstrating how to use the tool and addressing their issues.


```auspiceMainDisplayMarkdown
  # HPAI:
After this practice, participants will gain more independence as they create their HPAI narrative.
By then, they've had multiple encounters with this tool and they should feel more comfortable creating their narrative slides.

The HPAI dataset was created based on the current dataset I am using for my project. The Snakemake has been revised and a new GitHub repo is created for that dataset. 

# Virus:

<img  src="https://github.com/taneenak/zika/blob/main/figures/hpai%20eco.jpg?raw=true"  alt=":)"  width="70%" />


# Citation:
American Ornithological Society. (n.d.). Highly pathogenic avian influenza (HPAI): An emerging disease threat in North America. Retrieved June 17, 2024, from https://americanornithology.org/highly-pathogenic-avian-influenza-hpai-an-emerging-disease-threat-in-north-america/
